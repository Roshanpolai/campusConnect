...
// Required shape: <branchcode>.<sicid>@silicon.ac.in  e.g. ece.23becf33@silicon.ac.in
const SILICON_EMAIL_REGEX = new RegExp(`^[a-z]{2,10}\\.[a-z0-9]{4,20}@${ALLOWED_DOMAIN.replace(".", "\\.")}$`);
...
const userSchema = new mongoose.Schema(
  {
    ...
    role: {
      type: String,
      enum: ["student", "job_poster", "event_coordinator", "moderator", "super_admin"],
      default: "student",
    },
